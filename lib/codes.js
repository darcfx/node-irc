...
module.exports = {
    ...
    // 435 is also ERR_SERVICECONFUSED on Unreal, but looking at Unreal's source
    // it doesn't appear to be used. We DO see ERR_BANONCHAN (Bahamut) in the wild
    // though (on Freenode), so assume it is that.
    435: {
        name: 'err_banonchan',
        type: 'error',
    },
    ...
    // Seen in the wild on Freenode when trying to *connect* with the nickname "boot".
    // Also seen when trying to change nicks (cooldown period?)
    437: {
